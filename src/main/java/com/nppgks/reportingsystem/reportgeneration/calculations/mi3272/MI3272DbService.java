...
public class MI3272DbService {
    ...
    public String saveCalculations(List<ReportData> reportDataList, Report report) {
        ...
        List<Report> reports = reportRepository.findByDateRangeAndReportType(creationDate.atStartOfDay(), creationDate.atTime(LocalTime.MAX), ManualReportTypes.MI3272.name());
