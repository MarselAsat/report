...
public class KmhMassmByPuReportGenerator extends ManualReportGenerator {
    ...
    protected List<ReportData> generateReportDataList() {
        List<ManualTagForOpc> initialTags = manualTagService.getTagsByInitialAndReportType(true, ManualReportTypes.KMH_MASSM_BY_PU.name());
        ...
        List<ManualTagForOpc> finalTags = manualTagService.getTagsByInitialAndReportType(false, ManualReportTypes.KMH_MASSM_BY_PU.name());
