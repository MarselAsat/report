...
public class KmhMassmByMassmReportGenerator extends ManualReportGenerator {
    ...
    public KmhMassmByMassmReportGenerator(@Qualifier("saveManyTimesADayStrategy") SaveReportStrategy saveReportStrategy, OpcServiceRequests opcServiceRequests, ManualTagService manualTagService) {
    ...
    protected List<ReportData> generateReportDataList() {
        ...
        List<ManualTagForOpc> tags = manualTagService.getTagsByInitialAndReportType(true, ManualReportTypes.KMH_MASSM_BY_MASSM.name());
        ...
        Tag delta_maxTag = manualTagService.getTagByNameAndReportType("delta_max", ManualReportTypes.KMH_MASSM_BY_MASSM.name());
        Tag conclusionTag = manualTagService.getTagByNameAndReportType("conclusion", ManualReportTypes.KMH_MASSM_BY_MASSM.name());
