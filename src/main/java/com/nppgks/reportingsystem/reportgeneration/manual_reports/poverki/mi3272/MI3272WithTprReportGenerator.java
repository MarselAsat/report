...
import com.nppgks.reportingsystem.reportgeneration.manual_reports.poverki.mi3272.calculations.withtpr.MI3272TprFinalData;
...
@Service
public class MI3272WithTprReportGenerator extends ManualReportGenerator {
    ...
    public MI3272WithTprReportGenerator(@Qualifier("saveOnceADayStrategy") SaveReportStrategy saveReportStrategy, OpcServiceRequests opcServiceRequests, ManualTagService manualTagService, ManualReportTypeService manualReportTypeService) {
    ...
    private MI3272WithTprCalculator calculator;
    ...
    public String generateTprCoeff(){
        ...
        calculator = new MI3272WithTprCalculator();
    ...
    protected List<ReportData> generateReportDataList() {
        ...
        MI3272TprFinalData mi3272TprFinalData = calculator.calculateWithTpr();
        DataRounder.roundPojo(mi3272TprFinalData);
