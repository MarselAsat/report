...
VALUES (1, 'Q_ij', 'WinCC_OA.rep_test.' || 'Q_ij', '', TRUE, 'MI_3622'),
       ...
       (9, 'K_e_arr', 'WinCC_OA.rep_test.' || 'K_e_arr', '', TRUE, 'MI_3622'),
...
--        (22, 'calc_method', 'calc_method', TRUE, 'MI_3622'),
--        (23, 'calc_place', 'calc_place', TRUE, 'MI_3622'),
...
-- InitialTextData
INSERT INTO tag_name (id, permanent_name, name, description, initial, type)
VALUES (86, 'check_inspection', 'WinCC_OA.rep_test.' || 'check_inspection', '', TRUE, 'MI_3622'),
       (87, 'check_leakproofness', 'WinCC_OA.rep_test.' || 'check_leakproofness', '', TRUE, 'MI_3622'),
       (88, 'check_software', 'WinCC_OA.rep_test.' || 'check_software', '', TRUE, 'MI_3622'),
       (89, 'CPM_name', 'WinCC_OA.rep_test.' || 'CPM_name', '', TRUE, 'MI_3622'),
       (90, 'inspector_full_name', 'WinCC_OA.rep_test.' || 'inspector_full_name', '', TRUE, 'MI_3622'),
       (91, 'calc_place', 'WinCC_OA.rep_test.' || 'calc_place', '', TRUE, 'MI_3622'),
       (92, 'inspector_position', 'WinCC_OA.rep_test.' || 'inspector_position', '', TRUE, 'MI_3622'),
       (93, 'check_testing', 'WinCC_OA.rep_test.' || 'check_testing', '', TRUE, 'MI_3622'),
       (94, 'CPM_number', 'WinCC_OA.rep_test.' || 'CPM_number', '', TRUE, 'MI_3622'),
       (95, 'PR_name', 'WinCC_OA.rep_test.' || 'PR_name', '', TRUE, 'MI_3622'),
       (96, 'calc_method', 'WinCC_OA.rep_test.' || 'calc_method', '', TRUE, 'MI_3622'),
       (97, 'CPM_owner', 'WinCC_OA.rep_test.' || 'CPM_owner', '', TRUE, 'MI_3622'),
       (98, 'PR_number', 'WinCC_OA.rep_test.' || 'PR_number', '', TRUE, 'MI_3622'),
       (99, 'measureCount', 'WinCC_OA.rep_test.' || 'measureCount', '', TRUE, 'MI_3622'),
       (100, 'pointsCount', 'WinCC_OA.rep_test.' || 'pointsCount', '', TRUE, 'MI_3622'),
       (101, 'S_theta_D', 'WinCC_OA.rep_test.' || 'S_theta_D', '', FALSE, 'MI_3622'),
       (102, 'S_sigma_D', 'WinCC_OA.rep_test.' || 'S_sigma_D', '', FALSE, 'MI_3622'),
...
INSERT INTO tag_data(id, "data", data_type, tag_name_id, report_name_id)
VALUES (1, '[1, 2, 3, 4, 5]', 'array', 41, 1),
       (2, '[1, 2, 3, 4, 5]', 'array', 45, 1),
       (3, '[1, 2, 3, 4, 5]', 'array', 46, 1),
       (4, '[1, 2, 3, 4, 5]', 'array', 47, 1);
