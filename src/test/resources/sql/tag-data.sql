...
VALUES (1, 1, 'daily_mass_il1', 'Средний массовый расход', (SELECT id FROM report_type WHERE name = 'Суточный')),
       ...
       (5, 5, 'daily_density20_il1', 'Средняя плотность при 20 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
       (6, 6, 'daily_density15_il1', 'Средняя плотность при 15 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
...
VALUES (12, 1, 'daily_mass_il2', 'Средний массовый расход', (SELECT id FROM report_type WHERE name = 'Суточный')),
       ...
       (16, 5, 'daily_density20_il2', 'Средняя плотность при 20 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
       (17, 6, 'daily_density15_il2', 'Средняя плотность при 15 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
...
VALUES (23, 1, 'daily_mass_sikn', 'Средний массовый расход', (SELECT id FROM report_type WHERE name = 'Суточный')),
       ...
       (27, 5, 'daily_density20_sikn', 'Средняя плотность при 20 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
       (28, 6, 'daily_density15_sikn', 'Средняя плотность при 15 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
...
VALUES (34, 1, 'daily_mass_bik', 'Средний массовый расход', (SELECT id FROM report_type WHERE name = 'Суточный')),
       ...
       (38, 5, 'daily_density20_bik', 'Средняя плотность при 20 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
       (39, 6, 'daily_density15_bik', 'Средняя плотность при 15 С', (SELECT id FROM report_type WHERE name = 'Суточный')),
